...
public class SimonSaysRecipe extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		images.put(new Integer(KeyEvent.VK_UP), "imgres.jpg");
		images.put(new Integer(KeyEvent.VK_UP), "imgres.png");
		images.put(new Integer(KeyEvent.VK_UP), "url.png");

		// 3. Tell the user to "Press the matching key when 'Simon says' otherwise press a different key"
		JOptionPane.showMessageDialog(null, "press the matching key that 'Simon says' ptherwise press a different key. ");
